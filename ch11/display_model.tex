...
\cmakefile[firstline=7, lastline=8]{projects/11/shape_primitives/CMakeLists.txt}
\cmake'    # ...'
\cmakefile[firstline=10, lastline=13]{projects/11/shape_primitives/CMakeLists.txt}
...
\cmakefile[firstline=20, lastline=21]{projects/11/shape_primitives/CMakeLists.txt}
