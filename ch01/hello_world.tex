...
Если компиляция прошла успешно, то на экране не появится никаких сообщений. Это может смущать на первых порах. Поэтому можно вывести список файлов в текущем каталоге, чтобы убедиться в появлении исполняемого файла с именем \code{p}.
...
\WhatToReadSection
%%================
\textcite{Stroustrup:2016:ru}: \textbf{глава~3}
